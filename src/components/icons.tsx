import {
  ...
  Globe2, LayoutDashboard, LockKeyhole, Mail, Menu, Moon, Phone, Shield,
  Sparkles, Sun, UserRound, Users, X, Zap,
} from "lucide-react";

export const icons = { Award, Bitcoin, BookOpen, CheckCircle2, ClipboardList, FileBadge2, FileText, Globe2, LayoutDashboard, LockKeyhole, Mail, Menu, Moon, Phone, Shield, Sparkles, Sun, UserRound, Users, X, Zap };
